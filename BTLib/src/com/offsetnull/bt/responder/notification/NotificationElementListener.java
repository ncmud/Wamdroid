...
public class NotificationElementListener implements StartElementListener {
    ...
    public NotificationElementListener(
    ...
    public void start(Attributes a) {
        ...
        if (usedefaultlight.equals("true")) {
            ...
            r.setColorToUse(
                    (a.getValue("", BasePluginParser.ATTR_LIGHTCOLOR) == null)
                            ? 0xFFFF0000
                            : new BigInteger(a.getValue("", BasePluginParser.ATTR_LIGHTCOLOR), 16)
                                    .intValue());
        } else {
        ...
        if (usedefaultvibrate.equals("true")) {
            ...
            r.setVibrateLength(
                    (a.getValue("", BasePluginParser.ATTR_VIBRATELENGTH) == null)
                            ? 0
                            : Integer.parseInt(
                                    a.getValue("", BasePluginParser.ATTR_VIBRATELENGTH)));
        } else {
