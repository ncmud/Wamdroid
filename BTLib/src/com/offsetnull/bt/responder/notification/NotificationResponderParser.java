...
public final class NotificationResponderParser {
    public static void registerListeners(
        ...
        note.setStartElementListener(
                new NotificationElementListener(obj, current_trigger, current_timer));
    }

    public static void saveNotificationResponderToXML(XmlSerializer out, NotificationResponder r)
        ...
        if (r.isUseDefaultLight()) {
            ...
            out.attribute(
                    "", BasePluginParser.ATTR_LIGHTCOLOR, Integer.toHexString(r.getColorToUse()));
        } else {
        ...
        if (r.isUseDefaultVibrate()) {
            ...
            out.attribute(
                    "",
                    BasePluginParser.ATTR_VIBRATELENGTH,
                    Integer.toString(r.getVibrateLength()));
        } else {
        ...
        out.attribute(
                "",
                BasePluginParser.ATTR_NEWNOTIFICATION,
                (r.isSpawnNewNotification()) ? "true" : "false");
        out.attribute(
                "",
                BasePluginParser.ATTR_USEONGOING,
                (r.isUseOnGoingNotification()) ? "true" : "false");
