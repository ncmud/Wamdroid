...
/**
 * Utility class for looking up ansi and xterm 256 color codes. Also keeps a few easy string
 * constants to flavor strings with color.
 */
public final class Colorizer {
    ...
    private static SparseIntArray colormap256 =
            new SparseIntArray() {
     ...
     *
     * <p>This is deprecate, this is for the old TextView markup.
     *
    ...
    public static Object getColorCode(final Integer bright, final Integer value) {
        ...
        if (bright == null || bright == 0) {
            ...
            switch (onespot) {
                ...
                case ANSI_BLUE_CODE:
                    // blue
                    // colorval = colorval | 0xFF0000BB; //BB is too dark, turning it up, this
                    // hsould be an option.
    ...
    public static int getColorValue(
            final CharSequence bright, final CharSequence value, final boolean is256Color) {
    ...
    public static COLOR_TYPE getColorType(final Integer value) {
        ...
        if (value == XTERM_256_FOREGROUND) {
            return COLOR_TYPE.XTERM_256_FG_START;
        }

        if (value == XTERM_256_BACKGROUND) {
            return COLOR_TYPE.XTERM_256_BG_START;
        }

        if (value == XTERM_256_FIVE) {
     ...
     */
    public static int getColorValue(
            final Integer bright, final Integer value, final boolean is256color) {
        int colorval = 0x000000;

        if (is256color) {
            return get256ColorValue(value);
        }
        ...
        if (bright == null || bright == 0) {
            ...
            switch (onespot) {
                ...
                case ANSI_BLUE_CODE:
                    // blue
                    // colorval = colorval | 0x0000BB; //0x0000BB is a bit too dark on my screen, so
                    // i'm turning it up a bit. this should really be an option.
                    colorval = colorval | ANSI_BLUE;
                    break;
                case ANSI_MAGENTA_CODE:
                    // magenta
