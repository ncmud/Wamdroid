...
public class ButtonSetSelectorDialog extends Dialog {
    ...
    public ButtonSetSelectorDialog(
            Context context,
            Handler reportto,
            HashMap<String, Integer> datai,
            String selectedset,
            StellarService the_service) {
        super(context);
        dispater = reportto;
    ...
    public void buildList() {
        ...
        adapter =
                new ConnectionAdapter(
                        this.getContext(), R.layout.buttonset_selection_list_row, entries);
        ...
        newbutton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        NewButtonSetEntryDialog diag =
                                new NewButtonSetEntryDialog(
                                        ButtonSetSelectorDialog.this.getContext(),
                                        dispater,
                                        service);
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (setSettingsHaveChanged) {
                            // ListView lv =
                            // (ListView)ButtonSetSelectorDialog.this.findViewById(R.id.buttonset_list);
                            // ButtonEntry item = adapter.getItem(lv.getSelectedItemPosition());
                            Message reloadbuttonset = null;
                            //
                            // reloadbuttonset =
                            // dispater.obtainMessage(MainWindow.MESSAGE_CHANGEBUTTONSET,service.getLastSelectedSet());
                            //
                ...
                new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(
                        ...
                        for (int i = 0; i < adapter.getCount(); i++) {
                            ...
                            if (dostuff) {
                                arg0.getChildAt(index)
                                        .findViewById(R.id.toolbar_tab)
                                        .setFocusable(false);
    ...
    public void onStart() {
        ...
        if (noSets) {
            Toast t =
                    Toast.makeText(
                            ButtonSetSelectorDialog.this.getContext(),
                            "No button sets loaded. Click below to create new Button Sets.",
                            Toast.LENGTH_LONG);
            t.show();
        }
        adapter.notifyDataSetInvalidated();
    ...
    private class DeleteSetListener implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialog, int which) {
            AlertDialog.Builder confirm =
                    new AlertDialog.Builder(ButtonSetSelectorDialog.this.getContext());
    ...
    private class ConnectionAdapter extends ArrayAdapter<ButtonEntry> {
        ...
        public ConnectionAdapter(
                Context context, int textViewResourceId, List<ButtonEntry> objects) {
        ...
        public View getView(int pos, View convertView, ViewGroup parent) {
            ...
            if (e != null) {
                ...
                int width =
                        load.getDrawable().getIntrinsicWidth()
                                + lock.getDrawable().getIntrinsicWidth()
                                + modify.getDrawable().getIntrinsicWidth()
                                + delete.getDrawable().getIntrinsicWidth();
                ...
                delete.setOnClickListener(
                        new DeleteButtonListener(
                                pos, (ViewFlipper) v.findViewById(R.id.flipper), width));

                v.findViewById(R.id.toolbar_tab)
                        .setOnClickListener(
                                new ToolbarTabOpenListener(
                                        v, (ViewFlipper) v.findViewById(R.id.flipper), width, pos));

                v.findViewById(R.id.toolbar_tab_close)
                        .setOnClickListener(
                                new ToolbarTabCloseListener(
                                        v,
                ...
                extra.setText(
                        getContext()
                                .getResources()
                                .getQuantityString(
                                        R.plurals.fmt_contains_buttons, e.entries, e.entries));
    ...
    public class LoadButtonListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Message changebuttonset =
                    dispater.obtainMessage(MainWindow.MESSAGE_CHANGEBUTTONSET, item.name);
            dispater.sendMessage(changebuttonset);
            ButtonSetSelectorDialog.this.dismiss();
        }
    }
    ...
    public class DeleteButtonListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            builder.setPositiveButton(
                    "Delete", new ReallyDeleteTriggerListener(flip, animateDistance, entry));
    ...
    private static class EditorDoneHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            // if we got this, it means some settings have changed, and we should reload the button
            // set when we are done regardless if it is the one already selected, or cancelled.
