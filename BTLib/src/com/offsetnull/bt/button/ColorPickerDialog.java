...
public class ColorPickerDialog extends Dialog {
    ...
    private static class ColorPickerView extends View implements SeekBar.OnSeekBarChangeListener {
        ...
        ColorPickerView(Context c, OnColorChangedListener l, int color) {
            ...
            mColors =
                    new int[] {
                        (alphapart | 0x00FF0000),
                        (alphapart | 0x00FF00FF),
                        (alphapart | 0x000000FF),
                        (alphapart | 0x0000FFFF),
                        (alphapart | 0x0000FF00),
                        (alphapart | 0x00FFFF00),
                        (alphapart | 0x00FF0000)
                    };
            ...
            mCenterIndicator.setTextSize(
                    10.0f * this.getContext().getResources().getDisplayMetrics().density);
            ...
            // circle_path.addCircle(0, 0, (float) (CENTER_X - mPaint.getStrokeWidth()*0.5f*0.5),
            // Direction.CW);
            // Matrix m = new Matrix();
            // m.reset();
            // m.postRotate(-90);
        ...
        protected void onDraw(Canvas canvas) {
            // float scale = this.getContext().getResources().getDisplayMetrics().density;
            // Log.e("COLORPICK","CENTER_X:" + CENTER_X + " || mPaint.strokewidth" +
            ...
            canvas.drawTextOnPath(
                    "Select Inside To Confirm.", circle_path, 0, -3, mCenterIndicator);
            ...
            if (mTrackingCenter) {
                ...
                canvas.drawCircle(
                        0, 0, CENTER_RADIUS + mCenterPaint.getStrokeWidth(), mCenterPaint);
    ...
    public ColorPickerDialog(
            Context context, OnColorChangedListener listener, double initialColor) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout.LayoutParams titlep =
                new RelativeLayout.LayoutParams((int) (166.66 * scale), LayoutParams.WRAP_CONTENT);
        ...
        barparams.topMargin =
                (int) (5 * this.getContext().getResources().getDisplayMetrics().density);
