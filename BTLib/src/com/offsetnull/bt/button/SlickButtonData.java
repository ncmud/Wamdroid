...
public class SlickButtonData {
    ...
    public static final int DEFAULT_COLOR = 0x880000FF;
    public static final int DEFAULT_SELECTED_COLOR = 0x8800FF00;
    public static final int DEFAULT_FLIP_COLOR = 0x88FF0000;
    public static final int DEFAULT_LABEL_COLOR = 0xAAAAAAAA;
    public static final int DEFAULT_FLIPLABEL_COLOR = 0x990000FF;
    ...
    public boolean equals(Object aTest) {
        ...
        // Log.e("SLICKBUTTONDATA","Comparing " + this.toString() + " against " + test.toString() +
        // " returning " + retval);
    ...
    public String toString() {
        ...
        return x
                ...
                + y
                + "||"
                + (text.equals("") ? "[NONE]" : text)
                + "||"
                + (label.equals("") ? "[NONE]" : label)
                + "||"
                + (flipCommand.equals("") ? "[NONE]" : flipCommand)
                + "||"
                + MOVE_STATE
                + "||"
                + targetSet
