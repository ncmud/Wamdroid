...
public class BetterEditText extends EditText {
    ...
    public class EditableInputConnection extends BaseInputConnection {
        ...
        public boolean endBatchEdit() {
            synchronized (this) {
                if (mBatchEditNesting > 0) {
                    ...
                    // is called, some endBatchEdit calls may still be asynchronously received from
                    // the
            ...
            if (mTextView != null) {
                ...
                if (mTextView.extractText(request, et)) {
                    if ((flags & GET_EXTRACTED_TEXT_MONITOR) != 0) {
                        ...
                        // this method is not available to us however if we are using this we don't
                        // care about extracted text.
                    }
                    return et;
                }
            }
        ...
        public boolean commitText(CharSequence text, int newCursorPosition) {
            ...
            if (text instanceof Spanned) {
                ...
                // SuggestionSpan[] spans = spanned.getSpans(0, text.length(),
                // SuggestionSpan.class);
                // InputManager mIMM =
                // (InputManager)mTextView.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    public boolean onCheckIsTextEditor() {
        // Log.e("BETTEREDIT","CHECKING IF TEXT EDITOR: super returns: " +
