...
public class MainWindow extends AppCompatActivity
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (!isServiceRunning()) {
            ...
            // Intent(com.happygoatstudios.bt.service.IStellarService.class.getName()));
            // servicestarted = true;
        }
    ...
    private void handleMainMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case MESSAGE_RESETINPUTWINDOW:
                ...
                com.offsetnull.bt.window.Window w =
                        (com.offsetnull.bt.window.Window) findViewById(MAIN_WINDOW_ID);
                if (w != null) {
                    w.jumpToStart();
                }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (menuStack.size() > 0) {
            com.offsetnull.bt.window.Window tmp =
                    (com.offsetnull.bt.window.Window) rl.findViewWithTag(menuStack.peek().window);
        ...
        if (mWindows != null) {
            for (WindowToken w : mWindows) {
                com.offsetnull.bt.window.Window tmp =
                        (com.offsetnull.bt.window.Window) rl.findViewWithTag(w.getName());
                tmp.populateMenu(menu);
            }
        }
    ...
    public void onBackPressed() {
        ...
        if (menuStack.size() > 0) {
            ...
            com.offsetnull.bt.window.Window w =
                    (com.offsetnull.bt.window.Window) rl.findViewWithTag(tmp.window);
    ...
    private boolean isServiceRunning() {
        ...
        for (RunningServiceInfo service : services) {
            if (com.offsetnull.bt.service.StellarService.class
                    .getName()
    ...
    public void initiailizeWindows() {
        ...
        for (Object x : mWindows) {
            ...
            com.offsetnull.bt.window.Window v =
                    (com.offsetnull.bt.window.Window) rl.findViewWithTag(w.getName());
            if (v != null) {
                v.runScriptOnCreate();
            } else {
    ...
    private void initWindow(WindowToken w, String dataDir) {
        ...
        if (v == null) {
            ...
            com.offsetnull.bt.window.Window tmp =
                    new com.offsetnull.bt.window.Window(
                            dataDir,
                            this,
                            w.getName(),
                            w.getPluginName(),
            ...
            if (x instanceof WindowToken) {
                ...
                if (tmp instanceof com.offsetnull.bt.window.Window) {
                    service.unregisterWindowCallback(
                            w.getDisplayHost(),
                            ((com.offsetnull.bt.window.Window) tmp).getCallback());
    ...
    public void callWindowScript(String window, String callback) {
        ...
        com.offsetnull.bt.window.Window lview =
                (com.offsetnull.bt.window.Window) rl.findViewWithTag(window);
        if (lview != null) {
