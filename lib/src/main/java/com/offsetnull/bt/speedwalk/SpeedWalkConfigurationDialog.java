...
public class SpeedWalkConfigurationDialog extends Dialog implements DirectionEditorDoneListener {
    ...
    private void buildList() {
        HashMap<String, DirectionData> map =
        ...
        public void onClick(View v) {
            ...
            SpeedWalkDirectionEditorDialog editor =
                    new SpeedWalkDirectionEditorDialog(
                            SpeedWalkConfigurationDialog.this.getContext(),
                            SpeedWalkConfigurationDialog.this,
                            d,
                            service);
            editor.show();
        }
    ...
    private class DirectionAdapter extends ArrayAdapter<SWEntry> {
        ...
        public DirectionAdapter(
                Context context, int textViewResourceId, ArrayList<SWEntry> objects) {
        ...
        public View getView(int position, View v, ViewGroup parent) {
            ...
            if (tmp != null) {
                ((TextView) v.findViewById(R.id.dir_str))
                        .setText(
                                getContext()
                                        .getString(R.string.fmt_direction_arrow, tmp.dir, tmp.cmd));
