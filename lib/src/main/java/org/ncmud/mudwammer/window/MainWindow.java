...
import org.ncmud.mudwammer.alias.BetterAliasSelectionDialog;
import org.ncmud.mudwammer.service.*;
import org.ncmud.mudwammer.service.ConnectionCallback;
import org.ncmud.mudwammer.service.StellarService;
import org.ncmud.mudwammer.service.plugin.settings.BaseOption;
import org.ncmud.mudwammer.service.plugin.settings.OptionsDialog;
import org.ncmud.mudwammer.service.plugin.settings.SettingsGroup;
import org.ncmud.mudwammer.settings.ConfigurationLoader;
import org.ncmud.mudwammer.settings.HyperSettings;
import org.ncmud.mudwammer.speedwalk.BetterSpeedWalkConfigurationDialog;
import org.ncmud.mudwammer.timer.BetterTimerSelectionDialog;
import org.ncmud.mudwammer.trigger.BetterTriggerSelectionDialog;
import org.ncmud.mudwammer.ui.SDCardUtils;
...
public class MainWindow extends AppCompatActivity
        implements MainWindowCallback, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    HashMap<String, org.ncmud.mudwammer.window.Window> windowMap = null;
    ...
    Boolean settingsLoaded =
            false; // synchronize or try to mitigate failures of writing button data, or failures to
    // read data
    ...
    public void onCreate(Bundle icicle) {
        ...
        windowMap = new HashMap<String, org.ncmud.mudwammer.window.Window>(0);
        ...
        RelativeLayout.LayoutParams dividerparams =
                (android.widget.RelativeLayout.LayoutParams) divider.getLayoutParams();
        ...
        mInputBox.setOnEditorActionListener(
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (mFoldoutBar == null) {
                            ...
                            ImageButton dc =
                                    (ImageButton) mFoldoutBar.findViewById(R.id.down_btn_c);
                            ImageButton uc = (ImageButton) mFoldoutBar.findViewById(R.id.up_btn_c);
                            ImageButton ec =
                                    (ImageButton) mFoldoutBar.findViewById(R.id.enter_btn_c);
                                    ...
                                    new View.OnClickListener() {
                                        ...
                                        public void onClick(View arg0) {
                                            myhandler.sendEmptyMessage(
                                                    MainWindow.MESSAGE_PROCESSINPUTWINDOW);
                                            // screen2.jumpToZero();
                                        }
                                    });

                            // RelativeLayout rl = (RelativeLayout)
                            // MainWindow.this.findViewById(R.id.window_container);
                        ...
                        // foldoutbuttonwidth = (int)
                        // (40*MainWindow.this.getResources().getDisplayMetrics().density);
                        ...
                        if (input_controls_expanded) {
                            ...
                            // TranslateAnimation outanimB = new
                            // TranslateAnimation(0,-1*amount,0,0);
                            // outanim.setDuration(320);
                            // TranslateAnimation outanimC = new
                            // TranslateAnimation(0,-1*amount,0,0);
                            // outanim.setDuration(320);
        ...
        if (!isServiceRunning()) {
            // start the service
            // if("org.ncmud.mudwammer.MainWindow.NORMAL_MODE".equals(this.getIntent().getAction())) {
            ...
            /*if(mode == LAUNCH_MODE.FREE) {
            	this.startService(new Intent(org.ncmud.mudwammer.service.IStellarService.class.getName() + ".MODE_NORMAL"));
            ...
            // Intent(org.ncmud.mudwammer.service.IStellarService.class.getName()));
            // servicestarted = true;
        }
        ...
        mInputBarAnimationListener =
                new BetterEditText.AnimationEndListener() {
        ...
        this.getSupportActionBar()
                .setDisplayOptions(0, androidx.appcompat.app.ActionBar.DISPLAY_SHOW_HOME);
        this.getSupportActionBar()
                .setDisplayOptions(0, androidx.appcompat.app.ActionBar.DISPLAY_SHOW_TITLE);

        Button b = new Button(this);
        b.setBackgroundColor(0x00000000);
        // b.setBackgroundColor(0x33FF0000);
        androidx.appcompat.app.ActionBar.LayoutParams tmp2 =
                new androidx.appcompat.app.ActionBar.LayoutParams(
                        androidx.appcompat.app.ActionBar.LayoutParams.MATCH_PARENT,
                        androidx.appcompat.app.ActionBar.LayoutParams.WRAP_CONTENT);

        LinearLayout.LayoutParams tmp =
        ...
        // androidx.appcompat.widget.Toolbar parent =(androidx.appcompat.widget.Toolbar)
        // customView.getParent();
        ...
        switch (msg.what) {
            ...
            case MESSAGE_ADDOPTIONCALLBACK:
                ...
                if (msg.obj instanceof Drawable) {
                    cb =
                            new ScriptOptionCallback(
                                    datab.getString("window"),
            ...
            case MESSAGE_BELLTOAST:
                Toast belltoast =
                        Toast.makeText(MainWindow.this, "No actual message.", Toast.LENGTH_LONG);
                // t.setView(view);
                ...
                belltoast.setGravity(
                        Gravity.TOP | Gravity.END, (int) (40 * density), (int) (30 * density));
            ...
            case MESSAGE_SHOWTOAST:
                ...
                Snackbar bar =
                        Snackbar.make(
                                        findViewById(R.id.window_container),
                                        (String) msg.obj,
            ...
            case MESSAGE_DIRTYEXITNOW:
                // the service via an entered command ".closewindow" or something, to bypass the
                // window asking if you want to close
                dirtyExit();
                finish();
                break;
            ...
            case MESSAGE_LOADSETTINGS:
                // the service is connected at this point, so the service is alive and settings are
                // loaded
            ...
            case MESSAGE_RESETINPUTWINDOW:
                ...
                org.ncmud.mudwammer.window.Window w =
                        (org.ncmud.mudwammer.window.Window) findViewById(MAIN_WINDOW_ID);
                if (w != null) {
                    w.jumpToStart();
                }
    ...
    View.OnTouchListener mEditBoxTouchListener =
            new View.OnTouchListener() {
    ...
    protected void setUseCompatibilityMode(boolean value) {
        ...
        InputMethodManager imm =
                (InputMethodManager)
                        mInputBox.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (menuStack.size() > 0) {
            org.ncmud.mudwammer.window.Window tmp =
                    (org.ncmud.mudwammer.window.Window) rl.findViewWithTag(menuStack.peek().window);
        ...
        if (mWindows != null) {
            for (WindowToken w : mWindows) {
                org.ncmud.mudwammer.window.Window tmp =
                        (org.ncmud.mudwammer.window.Window) rl.findViewWithTag(w.getName());
                tmp.populateMenu(menu);
            }
        }
        ...
        //			Button b = new Button(this);
        //			b.setText("YEA YAAAA");
        //			LinearLayout.LayoutParams tmp = new
        ...
        MenuItemCompat.setShowAsAction(
                ...
                (hide == true) ? MenuItem.SHOW_AS_ACTION_NEVER : MenuItem.SHOW_AS_ACTION_IF_ROOM);
        MenuItemCompat.setShowAsAction(
        ...
        MenuItemCompat.setShowAsAction(
                ...
                (hide == true) ? MenuItem.SHOW_AS_ACTION_NEVER : MenuItem.SHOW_AS_ACTION_IF_ROOM);
        // menu.add(0,102,0,"Button
        // Sets").setIcon(R.drawable.ic_menu_button_sets).setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case 1500:
                if (SDCardUtils.hasPermissions(
                        this, findViewById(R.id.window_container), RP_INFO)) {
            ...
            case 1300:
                if (SDCardUtils.hasPermissions(
                        this, findViewById(R.id.window_container), RP_EXPORT)) {
                    doExportDialog();
                }
                // export
                break;
            case 1400:
                if (SDCardUtils.hasPermissions(
                        this, findViewById(R.id.window_container), RP_IMPORT)) {
                    doImportDialog(true);
                }
                break;
            case 600:
            ...
            case 500: // speedwalk config
                BetterSpeedWalkConfigurationDialog swDialog =
                        new BetterSpeedWalkConfigurationDialog(this, service);
                swDialog.show();
                break;
            case 900:
                this.cleanExit();
            ...
            //			try{
            //				buttoneditor = new
            // ButtonSetSelectorDialog(this,myhandler,(HashMap<String,Integer>)service.getButtonSetListInfo(),service.getLastSelectedSet(),service);
            ...
            //		case 400:
            //
            //			MainWindow.this.myhandler.postDelayed(new Runnable() { public void run() {
            // openOptionsMenu();}}, 1);
            //
            //			break;
            case 400:
                ...
                optdialog.show();
                // OptionsDialogFragment odf = new
                // OptionsDialogFragment(service,"main",getFragmentManager());
            ...
            case 200:
                ...
                // TriggerSelectionDialog trigger_selector = new
                // TriggerSelectionDialog(this,service);
                // trigger_selector.show();
                BetterTriggerSelectionDialog btsd =
                        new BetterTriggerSelectionDialog(this, service, mShowRegexWarning);
                btsd.show();
                break;
            default:
                break;
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        MainWindow.this.myhandler.sendMessage(
                                MainWindow.this.myhandler.obtainMessage(
                                        MainWindow.MESSAGE_EXPORTSETTINGS, path));
                        dialog.dismiss();
                    }
                });
    ...
    private void doResetDialog() {
        ...
        b.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        MainWindow.this.myhandler.sendEmptyMessage(
                                MainWindow.this.MESSAGE_DORESETSETTINGS);
                        dialog.dismiss();
                    }
                });
    ...
    public void onBackPressed() {
        ...
        if (menuStack.size() > 0) {
            ...
            org.ncmud.mudwammer.window.Window w =
                    (org.ncmud.mudwammer.window.Window) rl.findViewWithTag(tmp.window);
    ...
    private boolean isServiceRunning() {
        ...
        ActivityManager activityManager =
                (ActivityManager) MainWindow.this.getSystemService(Context.ACTIVITY_SERVICE);
        List<RunningServiceInfo> services = activityManager.getRunningServices(Integer.MAX_VALUE);
        boolean found = false;
        String serviceProcessName =
                "org.ncmud.mudwammer"
                        + ConfigurationLoader.getConfigurationValue("serviceProcessName", this);
        for (RunningServiceInfo service : services) {
            if (org.ncmud.mudwammer.service.StellarService.class
                    .getName()
    ...
    public void cleanExit() {
        ...
        // String serviceBindAction = ConfigurationLoader.getConfigurationValue("serviceBindAction",
        // this);
        // this.stopService(new Intent(serviceBindAction));
        /*if(mode == LAUNCH_MODE.FREE) {
        	this.stopService(new Intent(org.ncmud.mudwammer.service.IStellarService.class.getName() + ".MODE_NORMAL"));
        } else if(mode == LAUNCH_MODE.TEST) {
        	this.stopService(new Intent(org.ncmud.mudwammer.service.IStellarService.class.getName() + ".MODE_TEST"));
        }*/
    ...
    public void onStart() {
        ...
        super.onStart();
        /*if("org.ncmud.mudwammer.window.MainWindow.NORMAL_MODE".equals(this.getIntent().getAction())) {
        	mode = LAUNCH_MODE.FREE;
        } else if("org.ncmud.mudwammer.window.MainWindow.TEST_MODE".equals(this.getIntent().getAction())) {
        	mode = LAUNCH_MODE.TEST;
        }*/
        // if(supportsActionBar()) {
    ...
    public void onResume() {
        ...
        if (!isBound) {
            ...
            if(mode == LAUNCH_MODE.FREE) {
            	//this.startService(new Intent(org.ncmud.mudwammer.service.IStellarService.class.getName() + ".MODE_NORMAL"));
            	bindService(new Intent(org.ncmud.mudwammer.service.IStellarService.class.getName()+".MODE_NORMAL"), mConnection, 0);
            } else if(mode == LAUNCH_MODE.TEST) {
            	//this.startService(new Intent(org.ncmud.mudwammer.service.IStellarService.class.getName() + ".MODE_TEST"));
            ...
            String serviceBindAction =
                    ConfigurationLoader.getConfigurationValue("serviceBindAction", this);
            this.bindService(
                    new Intent(serviceBindAction, null, this, StellarService.class),
                    mConnection,
                    0);
            ...
            // Log.e("LOG","RESUMING WINDOW WITH INTENT: display="+i.getStringExtra("DISPLAY")+"
            // host="+i.getStringExtra("HOST")+" port="+i.getStringExtra("PORT"));
    ...
    private void loadSettings() {
        ...
        boolean fullscreen =
                (Boolean) ((BaseOption) group.findOptionByKey("fullscreen")).getValue();
        if (fullscreen) {
        ...
        mShowRegexWarning =
                (Boolean) ((BaseOption) (group.findOptionByKey("show_regex_warning"))).getValue();
        ...
        boolean keep_screen_on =
                (Boolean) ((BaseOption) group.findOptionByKey("screen_on")).getValue();
        ...
        boolean useExtractUI =
                (Boolean) ((BaseOption) group.findOptionByKey("fullscreen_editor")).getValue();
        boolean sugtmp =
                (Boolean) ((BaseOption) group.findOptionByKey("use_suggestions")).getValue();
        ...
        boolean compatibility =
                (Boolean) ((BaseOption) group.findOptionByKey("compatibility_mode")).getValue();
    ...
    public void setupEditor(boolean useExtractUI, boolean useSuggestions) {
        ...
        if (useExtractUI) {
            ...
            // Log.e("WINDOW","ATTEMPTING TO SET FULL SCREEN IME| WAS: "+
            // Integer.toHexString(current) +" WANT: " + Integer.toHexString(wanted));
            mInputBox.setImeOptions(wanted);
            mInputBox.setInputType(
            ...
            // Log.e("WINDOW","ATTEMPTING TO SET NO EXTRACT IME| WAS: "+
            // Integer.toHexString(current) +" WANT: " + Integer.toHexString(wanted));
            mInputBox.setImeOptions(wanted);
            if (useSuggestions) {
                mInputBox.setInputType(
    ...
    private ConnectionCallback the_callback =
            new ConnectionCallback() {
                ...
                public void doLineBreak(int i) {
                    myhandler.sendMessage(
                            myhandler.obtainMessage(MESSAGE_LINEBREAK, Integer.valueOf(i)));
                }

                public void reloadButtons(String setName) {
                    myhandler.sendMessage(
                            myhandler.obtainMessage(MESSAGE_CHANGEBUTTONSET, setName));
                }
                ...
                public void updateVitals2(int hp, int mp, int maxhp, int maxmana, int enemy) {
                ...
                public void setKeepLast(boolean keep) {
                    myhandler.sendMessage(
                            myhandler.obtainMessage(
                                    MESSAGE_SETKEEPLAST, (keep == true) ? 1 : 0, 0));
                }

                @Override
                public void setOrientation(int orientation) {
                    myhandler.sendMessage(
                            myhandler.obtainMessage(MESSAGE_SETORIENTATION, orientation, 0));
                }
                ...
                public void setKeepScreenOn(boolean value) {
                    myhandler.sendMessage(
                            myhandler.obtainMessage(
                                    MESSAGE_SETKEEPSCREENON, (value == true) ? 1 : 0, 0));
                }
                ...
                public void setUseFullscreenEditor(boolean value) {
                    myhandler.sendMessage(
                            myhandler.obtainMessage(
                                    MESSAGE_USEFULLSCREENEDITOR, (value == true) ? 1 : 0, 0));
                }
                ...
                public void setUseSuggestions(boolean value) {
                    myhandler.sendMessage(
                            myhandler.obtainMessage(
                                    MESSAGE_USESUGGESTIONS, (value == true) ? 1 : 0, 0));
                }
                ...
                public void setCompatibilityMode(boolean value) {
                    myhandler.sendMessage(
                            myhandler.obtainMessage(
                                    MESSAGE_USECOMPATIBILITYMODE, (value == true) ? 1 : 0, 0));
                }
                ...
                public void setRegexWarning(boolean value) {
                    ...
                    myhandler.sendMessage(
                            myhandler.obtainMessage(
                                    MESSAGE_SHOWREGEXWARNING, (value == true) ? 1 : 0, 0));
                }
            };
    ...
    public void initiailizeWindows() {
        ...
        // make windows in the order they are given, attach the callback and the view to the layout
        // root.
        ...
        // if(supportsRotation()) {
        //	landscape = (display.getRotation() == Surface.ROTATION_180 || display.getRotation() ==
        // Surface.ROTATION_90) ? true : false;
        // } else {
        ...
        if (mWindows == null || mWindows.length == 0) {
            ...
            if (mWindows == null || mWindows.length == 0) {
                Log.w(
                        "MUDWammer",
                        "No window tokens received after "
                                + maxRetries
                                + " retries, skipping window initialization");
                return;
            }
        }
        ...
        for (Object x : mWindows) {
            ...
            org.ncmud.mudwammer.window.Window v =
                    (org.ncmud.mudwammer.window.Window) rl.findViewWithTag(w.getName());
            if (v != null) {
                v.runScriptOnCreate();
            } else {
    ...
    private void initWindow(WindowToken w, String dataDir) {
        ...
        if (v == null) {
            ...
            org.ncmud.mudwammer.window.Window tmp =
                    new org.ncmud.mudwammer.window.Window(
                            dataDir,
                            this,
                            w.getName(),
                            w.getPluginName(),
            ...
            // boolean landscape = ((screenLayout & Configuration.SCREENLAYOUT_LONG_MASK) ==
            // Configuration.SCREENLAYOUT_LONG_NO) ? true : false;
            ...
            RelativeLayout.LayoutParams params =
                    (android.widget.RelativeLayout.LayoutParams) w.getLayout(screenSize, landscape);
            if (params == null) {
                params =
                        (android.widget.RelativeLayout.LayoutParams)
                                w.getLayout(screenSize, !landscape);
            }
    ...
    public void cleanupWindows() {
        ...
        for (Object x : mWindows) {
            if (x instanceof WindowToken) {
                ...
                if (tmp instanceof org.ncmud.mudwammer.window.Window) {
                    service.unregisterWindowCallback(
                            w.getDisplayHost(),
                            ((org.ncmud.mudwammer.window.Window) tmp).getCallback());
                    Log.e("WINDOW", "SHUTTING DOWN WINDOW " + w.getName());
                    ((org.ncmud.mudwammer.window.Window) tmp).shutdown();
                }
            }
        }
        ...
        for (Object x : mWindows) {
            if (x instanceof WindowToken) {
                ...
                View tmp = rl.findViewWithTag(w.getName());
                if (tmp instanceof org.ncmud.mudwammer.window.Window) {
                    ((org.ncmud.mudwammer.window.Window) tmp).closeLua();
        ...
        RelativeLayout.LayoutParams pl =
                new RelativeLayout.LayoutParams(
                        ...
                        (int) (3 * this.getResources().getDisplayMetrics().density));
    ...
    public void callWindowScript(String window, String callback) {
        ...
        org.ncmud.mudwammer.window.Window lview =
                (org.ncmud.mudwammer.window.Window) rl.findViewWithTag(window);
        if (lview != null) {
            lview.callFunction(callback, null);
        }
    }

    public void shutdownWindow(org.ncmud.mudwammer.window.Window window) {
    ...
    public boolean checkWindowSupports(String desired, String function) {
        org.ncmud.mudwammer.window.Window window = windowMap.get(desired);
        if (window != null) {
    ...
    public void windowBroadcast(String function, String data) {
        for (org.ncmud.mudwammer.window.Window window : windowMap.values()) {
    ...
    private void showImportMessage(final boolean external) {
        ...
        String message =
                (external == true)
                        ? String.format(getString(R.string.launcher_import_granted), dir)
                        : String.format(getString(R.string.launcher_import_denied), dir);
        Snackbar bar =
                Snackbar.make(mRootView, message, Snackbar.LENGTH_INDEFINITE)
                        .setAction(
                                android.R.string.ok,
