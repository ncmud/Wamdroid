package org.ncmud.mudwammer.validator;
    ...
    public String validate() {
        ...
        for (String field : validation_list.keySet()) {
            ...
            if ((tmp.What & VALIDATE_HOSTNAME) == VALIDATE_HOSTNAME) {
                ...
                // because apparantly EVERYTHING YOU ENTER CAN BE A VALID URL BY THE URL and
                // INETADDRESS CLASS
                ...
                if (!tmp.field.getText().toString().equals("")) {
                    if (tmp.field.getText().toString().contains(":")) {
                        validated = false;
                        message +=
                                tmp.field.getText().toString()
                                        + " is not a valid hostname. Should be of the form"
                                        + " hostname.com or IP address.\n";
