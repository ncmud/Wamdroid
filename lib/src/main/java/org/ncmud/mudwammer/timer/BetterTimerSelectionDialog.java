...
public class BetterTimerSelectionDialog extends PluginFilterSelectionDialog
        implements BaseSelectionDialog.UtilityToolbarListener {

    HashMap<String, TimerData> dataMap;
    String[] sortedKeys;

    public BetterTimerSelectionDialog(Context context, StellarService service) {
            ...
            case 2:
                ...
                TimerEditorDialog editor =
                        new TimerEditorDialog(
                                BetterTimerSelectionDialog.this.getContext(),
                                currentPlugin,
                                d,
                                service,
    ...
    public void onHelp() {
        Intent web_help =
                new Intent(
                        Intent.ACTION_VIEW,
                        Uri.parse("http://bt.happygoatstudios.com/?view=timers"));
    ...
    private void buildList() {
        ...
        for (int i = 0; i < sortedKeys.length; i++) {
            ...
            this.addListItem(
                    data.getName(), data.getSeconds() + " Seconds. " + tag, resource, true);
        }
