...
public class TimerSelectionDialog extends Dialog {
        ...
        newbutton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        TimerEditorDialog newdialog =
                                new TimerEditorDialog(
                                        TimerSelectionDialog.this.getContext(),
                                        currentPlugin,
                                        null,
                                        service,
                                        doneHandler);
    ...
    private void buildList() {
        ...
        for (TimerData timer : timer_list.values()) {
            ...
            i.selected = false;
            // set up a listener
            // playpause_listeners.put(timer.getOrdinal().toString(), new
            // PlayPauseListener(timer.getOrdinal().intValue(),timer.isPlaying()));
            // reset_listeners.put(timer.getOrdinal().toString(), new
            // ResetListener(timer.getOrdinal().intValue()));
            if (i.playing) {
                anyplaying = true;
    ...
    public class TimerListAdapter extends ArrayAdapter<TimerItem> {
        ...
        public TimerListAdapter(Context context, int textViewResourceId, List<TimerItem> objects) {
            ...
            if (e != null) {
                ...
                extra.setText(
                        getContext()
                                .getResources()
                                .getQuantityString(
                                        R.plurals.fmt_seconds_label, e.seconds, e.seconds));
            ...
            if (targetHolder != null) {
                ...
                if (data.playing) {
                    ((ImageButton) theToolbar.getChildAt(1))
                            .setImageResource(R.drawable.toolbar_pause_button);
                } else {
                    ((ImageButton) theToolbar.getChildAt(1))
                            .setImageResource(R.drawable.toolbar_play_button);
                }
    ...
    private void makeToolbar() {
        ...
        toolbarLength =
                close.getDrawable().getIntrinsicWidth()
                        + (modify.getDrawable().getIntrinsicWidth() * 4);
    ...
    public class DeleteButtonListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            AlertDialog.Builder builder =
                    new AlertDialog.Builder(TimerSelectionDialog.this.getContext());
    ...
    public class StopButtonListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            playPauseButton.setImageResource(R.drawable.toolbar_play_button);
            RelativeLayout row =
                    (RelativeLayout) playPauseButton.getParent().getParent().getParent();
            ((ImageView) row.findViewById(R.id.icon))
                    .setImageResource(R.drawable.toolbar_mini_stop);
        }
    }
    ...
    public class PlayPauseButtonListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (entry.playing) {
                ...
                ((ImageView) row.findViewById(R.id.icon))
                        .setImageResource(R.drawable.toolbar_mini_pause);
            } else {
                entry.playing = true;
                if (currentPlugin.equals("main")) {
                ...
                RelativeLayout row = (RelativeLayout) v.getParent().getParent().getParent();
                ((ImageView) row.findViewById(R.id.icon))
                        .setImageResource(R.drawable.toolbar_mini_play);
            }
        }
    }
    ...
    private static class DoneHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 99:
                    // special editor non new exit, means we need to clear the progress wad of the
                    // ordinal.
