...
import org.ncmud.mudwammer.responder.ack.AckResponderEditor;
import org.ncmud.mudwammer.responder.notification.NotificationResponder;
import org.ncmud.mudwammer.responder.notification.NotificationResponderEditor;
import org.ncmud.mudwammer.responder.toast.ToastResponder;
import org.ncmud.mudwammer.responder.toast.ToastResponderEditor;
...
public class TimerEditorDialog extends Dialog
    ...
    public TimerEditorDialog(
            Context c, String plugin, TimerData input, StellarService pService, Handler reportto) {
        super(c);
        service = pService;
    ...
    private class TimerEditerDoneListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            checker.add(
                    seconds,
                    Validator.VALIDATE_NOT_BLANK
                            | Validator.VALIDATE_NUMBER
                            | Validator.VALIDATE_NUMBER_NOT_ZERO,
                    "Timer duration");
    ...
    private void refreshResponderTable() {
        ...
        for (TriggerResponder responder : the_timer.getResponders()) {
            ...
            label.setOnClickListener(
                    new EditResponderListener(the_timer.getResponders().indexOf(responder)));
            ...
            windowOpen.setOnCheckedChangeListener(
                    new WindowOpenCheckChangeListener(
                            the_timer.getResponders().indexOf(responder)));
            ...
            delete.setOnClickListener(
                    new DeleteResponderListener(the_timer.getResponders().indexOf(responder)));
    ...
    private class DeleteResponderListener
        ...
        public void onClick(View arg0) {
            AlertDialog.Builder builder =
                    new AlertDialog.Builder(TimerEditorDialog.this.getContext());
            ...
            case 1: // toast
                ToastResponderEditor tedit =
                        new ToastResponderEditor(
                                TimerEditorDialog.this.getContext(), null, TimerEditorDialog.this);
                tedit.show();
                break;
            case 2:
