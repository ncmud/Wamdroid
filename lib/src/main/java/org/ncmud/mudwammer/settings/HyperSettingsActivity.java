...
public class HyperSettingsActivity extends PreferenceActivity {
    ...
    protected void onCreate(Bundle b) {
        ...
        pimport.setSummary(
                "Import settings from .xml files in "
                        + Environment.getExternalStorageDirectory().getPath()
                        + "/"
                        + exportDir
                        + "/");
        pexport.setSummary(
                "Export settings to an .xml file in "
                        + Environment.getExternalStorageDirectory().getPath()
                        + "/"
                        + exportDir
                        + "/");
        ...
        xmlfile_list.setOnPreferenceChangeListener(
        ...
        export.setOnPreferenceChangeListener(
                new OnPreferenceChangeListener() {
    ...
    public void onStart() {
        ...
        // ViewGroup widget = (ViewGroup) preffer.getContext().getView(tmp,
        // null);//findViewById(preffer.getWidgetLayoutResource());
