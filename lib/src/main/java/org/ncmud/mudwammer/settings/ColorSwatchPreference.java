...
public class ColorSwatchPreference extends Preference
    ...
    public ColorSwatchPreference(Context context, AttributeSet attrs, int defStyle) {
                    ...
                    public void onClick(View v) {
                        ...
                        ColorPickerDialog d =
                                new ColorPickerDialog(
                                        v.getContext(), ColorSwatchPreference.this, colorValue);
                        d.show();
                    }
                });
    ...
    public void onDependencyChanged(Preference dependency, boolean disableDependent) {
        Log.e(
                "SWATCH",
                dependency.getKey() + "is telling me " + Boolean.toString(disableDependent));
        if (theView != null) {
            if (disableDependent) {
