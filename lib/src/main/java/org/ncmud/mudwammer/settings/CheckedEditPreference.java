        ...
        public boolean onKey(View v, int keyCode, KeyEvent event) {
            ...
            if (event.getAction() == KeyEvent.ACTION_UP) {
                ...
                if (!(towatch.getText().toString().equals(""))) {
                    ...
                    edit.putInt(
                            CheckedEditPreference.this.getKey(),
                            Integer.parseInt(towatch.getText().toString()));
                    edit.apply();
                    // Log.e("sfdFD","SAVING:" +towatch.getText().toString() + " with key: " +
                    // CheckedEditPreference.this.getKey());
                }
            }
    ...
    private class StateChanger implements CompoundButton.OnCheckedChangeListener {
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            if (isChecked) {
                ...
                edit.putInt(
                        CheckedEditPreference.this.getKey(),
                        Integer.parseInt(toggle1.getText().toString()));
                edit.apply();
            }
        }
    }
