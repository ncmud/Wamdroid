...
import org.ncmud.mudwammer.responder.*;
import org.ncmud.mudwammer.responder.TriggerResponder.FIRE_WHEN;
import org.ncmud.mudwammer.responder.TriggerResponder.RESPONDER_TYPE;
import org.ncmud.mudwammer.responder.ack.*;
import org.ncmud.mudwammer.responder.color.ColorAction;
import org.ncmud.mudwammer.responder.color.ColorActionEditor;
import org.ncmud.mudwammer.responder.gag.GagAction;
import org.ncmud.mudwammer.responder.gag.GagActionEditorDialog;
import org.ncmud.mudwammer.responder.notification.*;
import org.ncmud.mudwammer.responder.replace.ReplaceActionEditorDialog;
import org.ncmud.mudwammer.responder.replace.ReplaceResponder;
import org.ncmud.mudwammer.responder.script.ScriptResponder;
import org.ncmud.mudwammer.responder.script.ScriptResponderEditor;
import org.ncmud.mudwammer.responder.toast.*;
import org.ncmud.mudwammer.service.StellarService;
import org.ncmud.mudwammer.validator.Validator;
import org.ncmud.mudwammer.window.PluginFilterSelectionDialog;
...
public class TriggerEditorDialog extends Dialog
        implements DialogInterface.OnClickListener, TriggerResponderEditorDoneListener {
    ...
    public TriggerEditorDialog(
        ...
        ///	Log.e("TEDITOR","responder " + responder.getType() + " fires " +
        // responder.getFireType());
        // }
    ...
    public void onCreate(Bundle b) {
        ...
        setContentView(R.layout.trigger_editor_dialog);
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View arg0) {
                        ...
                        if (changed) {
                            ...
                            builder.setMessage(
                                    "You have changed the data of this trigger, are you sure you"
                                            + " want to dismiss?");
                                        ...
                                        public void onClick(DialogInterface arg0, int arg1) {
                                            switch (arg1) {
                                                ...
                                                case DialogInterface
                                                        .BUTTON_NEUTRAL: // save and quit
                                                    arg0.dismiss();
                                                    Button done =
                                                            (Button)
                                                                    TriggerEditorDialog.this
                                                                            .findViewById(
                                                                                    R.id
                                                                                            .trigger_editor_done_button);
                                                    done.performClick();
                                                    break;
                                            }
                                        }
    ...
    private boolean hasTriggerChanged() {
        ...
        if (test.getResponders().size() == the_trigger.getResponders().size()) {
            checkresponder = true;
        } else {
            retval = true;
        }
        ...
        if (checkresponder) {
            Iterator<TriggerResponder> test_responders =
                    original_trigger.getResponders().iterator();
    ...
    private class TriggerEditorDoneListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (isEditor) {
                ...
                // i don't care anymore about the checkchanged listeners. it was a neat idea, but
                // here goes.
    ...
    private void refreshResponderTable() {
        ...
        int checkboxnumber =
                123456; // generate semi unique id's each time we generate this table. we need to do
        // this because the check changed listeners are freaking. out.
        ...
        for (TriggerResponder responder : the_trigger.getResponders()) {
            ...
            label.setOnClickListener(
                    new EditResponderListener(the_trigger.getResponders().indexOf(responder)));
            if (responder.getType() == RESPONDER_TYPE.NOTIFICATION) {
                label.setText(
                        getContext()
                                .getString(
                                        R.string.fmt_notification_label,
                                        ((NotificationResponder) responder).getTitle()));
            } else if (responder.getType() == RESPONDER_TYPE.TOAST) {
                label.setText(
                        getContext()
                                .getString(
                                        R.string.fmt_toast_message_label,
                                        ((ToastResponder) responder).getMessage()));
            } else if (responder.getType() == RESPONDER_TYPE.ACK) {
                label.setText(
                        getContext()
                                .getString(
                                        R.string.fmt_ack_with_label,
                                        ((AckResponder) responder).getAckWith()));
            } else if (responder.getType() == RESPONDER_TYPE.SCRIPT) {
                label.setText(
                        getContext()
                                .getString(
                                        R.string.fmt_function_label,
                                        ((ScriptResponder) responder).getFunction()));
            } else if (responder.getType() == RESPONDER_TYPE.REPLACE) {
                label.setText(
                        getContext()
                                .getString(
                                        R.string.fmt_replace_label,
                                        ((ReplaceResponder) responder).getWith()));
                ...
                label.setText(
                        getContext()
                                .getString(
                                        R.string.fmt_color_label,
                                        ((ColorAction) responder).getColor()));
            }
            ...
            CheckBox windowOpen = new CheckBox(this.getContext());
            windowOpen.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL);
            windowOpen.setId(checkboxnumber);
            checkopens.put(the_trigger.getResponders().indexOf(responder), checkboxnumber);
            checkboxnumber++;

            CheckBox windowClose = new CheckBox(this.getContext());
            windowClose.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.CENTER_VERTICAL);
            windowClose.setId(checkboxnumber);
            checkclosed.put(the_trigger.getResponders().indexOf(responder), checkboxnumber);
            checkboxnumber++;

            windowOpen.setOnCheckedChangeListener(
                    new WindowOpenCheckChangeListener(
                            the_trigger.getResponders().indexOf(responder)));
            windowClose.setOnCheckedChangeListener(
                    new WindowClosedCheckChangeListener(
                            the_trigger.getResponders().indexOf(responder)));

            Button delete = new Button(this.getContext());
            delete.setBackgroundResource(android.R.drawable.ic_delete);
            delete.setOnClickListener(
                    new DeleteResponderListener(the_trigger.getResponders().indexOf(responder)));

            windowOpen.setGravity(Gravity.CENTER);
            windowOpen.setText("");
            windowClose.setGravity(Gravity.CENTER);
            windowClose.setText("");
            delete.setGravity(Gravity.CENTER | Gravity.CENTER_VERTICAL);

            l1.addView(windowOpen);
            l2.addView(windowClose);
            // windowOpen.setLayoutParams(params); windowClose.setLayoutParams(params);
            ...
            if (responder.getFireType() == FIRE_WHEN.WINDOW_OPEN
                    || responder.getFireType() == FIRE_WHEN.WINDOW_BOTH) {
            ...
            if (responder.getFireType() == FIRE_WHEN.WINDOW_CLOSED
                    || responder.getFireType() == FIRE_WHEN.WINDOW_BOTH) {
        ...
        public void onClick(View v) {
            ...
            switch (responder.getType()) {
                case NOTIFICATION:
                    ...
                    NotificationResponderEditor redit =
                            new NotificationResponderEditor(
                                    TriggerEditorDialog.this.getContext(),
                                    (NotificationResponder) responder.copy(),
                                    TriggerEditorDialog.this);
                    redit.show();
                    break;
                case TOAST:
                    ToastResponderEditor tedit =
                            new ToastResponderEditor(
                                    TriggerEditorDialog.this.getContext(),
                                    (ToastResponder) responder.copy(),
                                    TriggerEditorDialog.this);
                    tedit.show();
                    break;
                case ACK:
                    AckResponderEditor aedit =
                            new AckResponderEditor(
                                    TriggerEditorDialog.this.getContext(),
                                    (AckResponder) responder.copy(),
                                    TriggerEditorDialog.this);
                    aedit.show();
                    break;
                case SCRIPT:
                    ScriptResponderEditor sedit =
                            new ScriptResponderEditor(
                                    TriggerEditorDialog.this.getContext(),
                                    (ScriptResponder) responder.copy(),
                                    TriggerEditorDialog.this);
                    sedit.show();
                    break;
                case COLOR:
                    ColorActionEditor color =
                            new ColorActionEditor(
                                    TriggerEditorDialog.this.getContext(),
                                    (ColorAction) responder.copy(),
                                    TriggerEditorDialog.this);
                    color.show();
                    break;
                case GAG:
                    GagActionEditorDialog gag =
                            new GagActionEditorDialog(
                                    TriggerEditorDialog.this.getContext(),
                                    (GagAction) responder.copy(),
                                    TriggerEditorDialog.this);
                    gag.show();
                    break;
                case REPLACE:
                    ReplaceActionEditorDialog rep =
                            new ReplaceActionEditorDialog(
                                    TriggerEditorDialog.this.getContext(),
                                    (ReplaceResponder) responder.copy(),
                                    TriggerEditorDialog.this);
                    rep.show();
                    break;
                default:
    ...
    private class WindowOpenCheckChangeListener implements CompoundButton.OnCheckedChangeListener {
        ...
        public void onCheckedChanged(CompoundButton arg0, boolean checked) {
            if (checked) {
                ...
                /// Log.e("TEDITOR","TRIGGER TYPE " +
                // the_trigger.getResponders().get(position).getType().getIntVal() + " AT "+
                // position + " ADDING windowOpen");
            } else {
                the_trigger.getResponders().get(position).removeFireType(FIRE_WHEN.WINDOW_OPEN);
                // Log.e("TEDITOR","TRIGGER TYPE " +
                // the_trigger.getResponders().get(position).getType().getIntVal() + " AT "+
                // position + " REMOVING windowOpen");
            }
            // Log.e("TEDITOR","TRIGGER TYPE " + the_trigger.getResponders().get(position).getType()
            // + " AT "+ position + " NOW " +
            // the_trigger.getResponders().get(position).getFireType().getString());

        }
    }
    ;

    private class WindowClosedCheckChangeListener
        ...
        public void onCheckedChanged(CompoundButton arg0, boolean checked) {
            if (checked) {
                ...
                // Log.e("TEDITOR","TRIGGER TYPE " +
                // the_trigger.getResponders().get(position).getType().getIntVal() + " AT "+
                // position + " ADDING windowClosed");
            } else {
                the_trigger.getResponders().get(position).removeFireType(FIRE_WHEN.WINDOW_CLOSED);
                // Log.e("TEDITOR","TRIGGER TYPE " +
                // the_trigger.getResponders().get(position).getType().getIntVal() + " AT "+
                // position + " REMOVING windowClosed");

            }
            // Log.e("TEDITOR","TRIGGER TYPE " +
            // the_trigger.getResponders().get(position).getType().getIntVal() + " AT "+ position +
            // " NOW " + the_trigger.getResponders().get(position).getFireType().getString());

        }
    }
    ;

    private class DeleteResponderListener
    ...
    private class NewResponderListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            CharSequence[] items = {
                "Notification", "Toast Message", "Ack With", "Script", "Color", "Gag", "Replace"
            };
            AlertDialog.Builder builder =
                    new AlertDialog.Builder(TriggerEditorDialog.this.getContext());
    ...
    private class LiteralCheckChangedListener implements CompoundButton.OnCheckedChangeListener {
        ...
        public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
            if (arg1) {
                ...
                // builder.setMessage("You have turned on regular expression parsing for this
                // trigger. Poorly formed expressions can cause the following: break other triggers,
                // drain your battery, dump thousands of bytes to the server, etc. Please read the
                // guide to the Java Pattern Class if you need more information. Have a nice day.");
                ...
                String wikiViewURL = "";
                Linkify.TransformFilter transform =
    ...
    public void onClick(DialogInterface arg0, int arg1) {
        ...
        switch (arg1) {
            case 0: // notificaiton
                NotificationResponderEditor notifyEditor =
                        new NotificationResponderEditor(this.getContext(), null, this);
                notifyEditor.show();
                break;
            case 1: // toast
                ToastResponderEditor tedit =
    ...
    public void editTriggerResponder(TriggerResponder edited, TriggerResponder original) {
        ...
        // for(TriggerResponder responder : the_trigger.getResponders()) {
        // Log.e("TEDITOR","RESPONDER TYPE " + responder.getType() + " RESPONDS " +
        // responder.getFireType());
        // }
    }
