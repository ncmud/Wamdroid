...
public class BetterTriggerSelectionDialog extends PluginFilterSelectionDialog
    ...
    public BetterTriggerSelectionDialog(
            Context context, StellarService service, boolean showWarning) {
    ...
    public void onButtonPressed(View v, int row, int index) {
        ...
        TriggerEditorDialog editor =
                new TriggerEditorDialog(
                        BetterTriggerSelectionDialog.this.getContext(),
                        d,
                        service,
    ...
    public void onHelp() {
        Intent web_help =
                new Intent(
                        Intent.ACTION_VIEW,
                        Uri.parse("http://bt.happygoatstudios.com/?view=triggers"));
