...
public class AliasSelectionDialog extends Dialog implements AliasEditorDialogDoneListener {
    ...
    public AliasSelectionDialog(
            Context context, HashMap<String, AliasData> pinput, StellarService pService) {
        super(context);
        // reporto = useme;
        input = pinput;
        service = pService;
        ...
        butt.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View arg0) {
                        ...
                        AliasEditorDialog diag =
                                new AliasEditorDialog(
                                        AliasSelectionDialog.this.getContext(),
                                        AliasSelectionDialog.this,
                                        service,
                                        computeNames(""),
                                        currentPlugin);
    ...
    public class DeleteButtonListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            AlertDialog.Builder builder =
                    new AlertDialog.Builder(AliasSelectionDialog.this.getContext());
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MSG_DELETEALIAS:
                    ...
                    HashMap<String, AliasData> existingAliases =
                            (HashMap<String, AliasData>) outer.service.getAliases();
                ...
                case MSG_MODIFYALIAS:
                    ...
                    AliasEditorDialog diag =
                            new AliasEditorDialog(
                                    outer.getContext(),
                                    outer,
                                    ((AliasData) msg.obj).getPre(),
                                    ((AliasData) msg.obj).getPost(),
                                    position,
                                    (AliasData) msg.obj,
                                    outer.service,
                                    outer.computeNames(((AliasData) msg.obj).getPre()),
                                    outer.currentPlugin);
    ...
    private List<String> computeNames(String name) {
        ...
        HashMap<String, AliasData> existingAliases =
                (HashMap<String, AliasData>) service.getAliases();
    ...
    public void editAliasDialogDone(
            String pre, String post, boolean enabled, int pos, AliasData orig) {
        lastSelectedIndex = -1;
        if (theToolbar.getParent() != null) {
            ((RelativeLayout) theToolbar.getParent()).removeView(theToolbar);
        }
