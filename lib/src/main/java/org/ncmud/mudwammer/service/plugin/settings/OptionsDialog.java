...
import org.ncmud.mudwammer.button.ColorPickerDialog;
...
public class OptionsDialog extends Dialog {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (o.type) {
                ...
                case INTEGER:
                    ...
                    LinearLayout.LayoutParams iparam =
                            new LinearLayout.LayoutParams(
                                    LinearLayout.LayoutParams.WRAP_CONTENT,
                                    LinearLayout.LayoutParams.WRAP_CONTENT);
    ...
    private class FileOptionClickedListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            builder.setSingleChoiceItems(
                    entries,
                    selectedIndex,
                    new FileOptionItemClickListener(
                            (FileOption) o, foundFilePaths, foundFileNames));
    ...
    private class FileOptionItemClickListener implements DialogInterface.OnClickListener {
        ...
        public FileOptionItemClickListener(
                FileOption option, ArrayList<String> paths, ArrayList<String> names) {
            this.paths = paths;
            this.names = names;
            this.option = option;
        }
    ...
    private class ColorOptionClickedListener
        ...
        public void onClick(View v) {
            ...
            ColorPickerDialog dialog =
                    new ColorPickerDialog(
                            OptionsDialog.this.getContext(), this, (Integer) option.getValue());
            dialog.show();
        }
    ...
    private class IntegerOptionFinishedListener implements DialogInterface.OnClickListener {
        ...
        public IntegerOptionFinishedListener(
                IntegerOption option, EditText input, TextView widget) {
            this.option = option;
            this.input = input;
            this.widget = widget;
        }
    ...
    private class GroupClickedListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (backStack.size() == 0) {
                // we need to switch the current plugin so the appropriate settingsgroup gets
                // updated.
    ...
    private class ListOptionClickedListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            // builder.setSin
            builder.setSingleChoiceItems(
                    foo, ((Integer) o.getValue()).intValue(), new ListItemClickListener(o));
            ...
            outAnim.setAnimationListener(
                    new AnimationListener() {
                        ...
                        public void onAnimationEnd(Animation animation) {
                            ViewFlipper f =
                                    (ViewFlipper) OptionsDialog.this.findViewById(R.id.flipper);
