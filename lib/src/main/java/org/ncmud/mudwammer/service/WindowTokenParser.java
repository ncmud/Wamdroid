...
import org.ncmud.mudwammer.service.plugin.settings.PluginParser.NewItemCallback;
...
public final class WindowTokenParser {
    ...
    public static void registerListeners(
            final Element root, final WindowToken currentWindow, final NewItemCallback handler) {
                    ...
                    try {
                        ...
                        switch (key) {
                            ...
                            case hyperlink_color:
                                if (((Integer) ((ColorOption) o).getValue())
                                        != WindowToken.DEFAULT_HYPERLINK_COLOR) {
                                    out.startTag("", "option");
                                    out.attribute("", "key", key.toString());
                                    out.text(
                                            "#"
                                                    + Integer.toHexString(
                                                            (Integer)
                                                                    ((ColorOption) o).getValue()));
                                    out.endTag("", "option");
                                }
                                break;
                            case hyperlink_mode:
                                if (((Integer) ((ListOption) o).getValue())
                                        != WindowToken.DEFAULT_HYPERLINK_MODE) {
                                    out.startTag("", "option");
                                    out.attribute("", "key", key.toString());
                            ...
                            case color_option:
                                if (((Integer) ((ListOption) o).getValue())
                                        != WindowToken.DEFAULT_COLOR_MODE) {
                                    out.startTag("", "option");
                                    out.attribute("", "key", key.toString());
                                    out.text(((Integer) ((ListOption) o).getValue()).toString());
                                    out.endTag("", "option");
                            ...
                            case font_size:
                                Log.e(
                                        "SAVING WINDOW",
                                        "FONT SIZE:" + (Integer) ((IntegerOption) o).getValue());
                                if (((Integer) ((IntegerOption) o).getValue())
                                        != WindowToken.DEFAULT_FONT_SIZE) {
                                    out.startTag("", "option");
                                    out.attribute("", "key", key.toString());
                            ...
                            case line_extra:
                                if (((Integer) ((IntegerOption) o).getValue())
                                        != WindowToken.DEFAULT_LINE_EXTRA) {
                                    out.startTag("", "option");
                                    out.attribute("", "key", key.toString());
                                    out.text(((Integer) ((IntegerOption) o).getValue()).toString());
                                    out.endTag("", "option");
                            ...
                            case buffer_size:
                                if (((Integer) ((IntegerOption) o).getValue())
                                        != WindowToken.DEFAULT_BUFFER_SIZE) {
                                    out.startTag("", "option");
                                    out.attribute("", "key", key.toString());
                                    out.text(((Integer) ((IntegerOption) o).getValue()).toString());
                                    out.endTag("", "option");
                                ...
                                break;
                            case font_path:
                                if (!((String) ((FileOption) o).getValue())
                                        .equals(WindowToken.DEFAULT_FONT_PATH)) {
                                    out.startTag("", "option");
                                    out.attribute("", "key", key.toString());
