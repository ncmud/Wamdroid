...
import org.ncmud.mudwammer.service.plugin.settings.EncodingOption;
...
import org.ncmud.mudwammer.service.plugin.settings.StringOption;
...
public class ConnectionSettingsPlugin extends Plugin {
    public ConnectionSettingsPlugin(Handler h, ConnectionPluginCallback parent, String dataDir)
            throws LuaException {
        super(h, parent, null, dataDir);
        init();
    }

    public ConnectionSettingsPlugin(
            PluginSettings settings, Handler h, ConnectionPluginCallback parent, String dataDir)
            throws LuaException {
    ...
    private void init() {
        ...
        orientation.setDescription(
                "Sets the layout mode for the application. Automatic will switch the layout when"
                        + " the device rotates.");
        ...
        fullscreen.setDescription(
                "Hides the notification bar. This can be toggled by typing .togglefullscreen");
        ...
        fullscreen_editor.setDescription(
                "Show the full screen editor when the input bar is clicked.");
        ...
        use_suggestions.setDescription(
                "Attempt suggestions if the full screen editor is not used.");
        ...
        compatilibility_mode.setDescription(
                "Enable this if you have problems with bascpace not workin in the non-full screen"
                        + " editor.");
        ...
        process_system_commands.setDescription(
                "Perform system functions for input beginning with the specified system command"
                        + " marker.");
        ...
        auto_reconnect_limit.setDescription(
                "Hard limit of how many times reconnection will be attempted.");
        ...
        debug_telnet.setDescription(
                "Shows data involving telnet option transactions in the window.");
        ...
        show_regex_warning.setDescription(
                "Show the warning message about regular expressions in the trigger editor.");
        ...
        bell_display.setDescription(
                "Displays a small alert on the screen when the bell character is recieved.");
    ...
    public void importV1Settings(HyperSettings oldSettings) {
        ...
        this.getSettings()
                .getOptions()
                .setOption("keep_last", Boolean.toString(oldSettings.isKeepLast()));
        this.getSettings()
                .getOptions()
                .setOption(
                        "cull_extraneous_color",
                        Boolean.toString(oldSettings.isRemoveExtraColor()));
        this.getSettings()
                .getOptions()
                .setOption("debug_telnet", Boolean.toString(oldSettings.isDebugTelnet()));
        this.getSettings()
                .getOptions()
                .setOption("use_suggestions", Boolean.toString(oldSettings.isAttemptSuggestions()));
        this.getSettings().getOptions().setOption("encoding", oldSettings.getEncoding());
        this.getSettings()
                .getOptions()
                .setOption("bell_vibrate", Boolean.toString(oldSettings.isVibrateOnBell()));
        this.getSettings()
                .getOptions()
                .setOption("bell_notification", Boolean.toString(oldSettings.isNotifyOnBell()));
        this.getSettings()
                .getOptions()
                .setOption("bell_display", Boolean.toString(oldSettings.isDisplayOnBell()));
        this.getSettings()
                .getOptions()
                .setOption("fullscreen", Boolean.toString(oldSettings.isFullScreen()));
        this.getSettings()
                .getOptions()
                .setOption("screen_on", Boolean.toString(oldSettings.isKeepScreenOn()));
        this.getSettings()
                .getOptions()
                .setOption(
                        "process_system_commands", Boolean.toString(oldSettings.isProcessPeriod()));
        this.getSettings()
                .getOptions()
                .setOption("orientation", Integer.toString(oldSettings.getOrientation()));
        this.getSettings()
                .getOptions()
                .setOption("echo_alias_update", Boolean.toString(oldSettings.isEchoAliasUpdates()));
        this.getSettings()
                .getOptions()
                .setOption("fullscreen_editor", Boolean.toString(oldSettings.isUseExtractUI()));
        this.getSettings()
                .getOptions()
                .setOption("local_echo", Boolean.toString(oldSettings.isLocalEcho()));
        this.getSettings()
                .getOptions()
                .setOption("keep_wifi_alive", Boolean.toString(oldSettings.isKeepWifiActive()));
        this.getSettings()
                .getOptions()
                .setOption("compatibility_mode", Boolean.toString(oldSettings.isBackspaceBugFix()));
        this.getSettings()
                .getOptions()
                .setOption("process_semicolon", Boolean.toString(oldSettings.isSemiIsNewLine()));

        // set window token settings.
        this.getSettings()
                .getOptions()
                .setOption(
                        "hyperlinks_enabled", Boolean.toString(oldSettings.isHyperLinkEnabled()));
        ...
        this.getSettings()
                .getOptions()
                .setOption("hyperlink_color", Integer.toString(oldSettings.getHyperLinkColor()));
        this.getSettings()
                .getOptions()
                .setOption("word_wrap", Boolean.toString(oldSettings.isWordWrap()));
        this.getSettings()
                .getOptions()
                .setOption(
                        "color_option",
                        Integer.toString((oldSettings.isDisableColor() == true) ? 1 : 0));
        this.getSettings()
                .getOptions()
                .setOption("font_size", Integer.toString(oldSettings.getLineSize()));
        this.getSettings()
                .getOptions()
                .setOption("line_extra", Integer.toString(oldSettings.getLineSpaceExtra()));
        this.getSettings()
                .getOptions()
                .setOption("buffer_size", Integer.toString(oldSettings.getMaxLines()));
