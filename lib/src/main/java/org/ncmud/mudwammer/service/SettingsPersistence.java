...
public class SettingsPersistence {
    ...
    public final void saveMainSettings() {
        ...
        String internal =
                context.getService().getApplicationContext().getApplicationInfo().dataDir
                        + "/files/";
    ...
    public final void exportSettings(final String path) {
        ...
        if (!filename.startsWith("/")) {
            ...
            String dir =
                    ConfigurationLoader.getConfigurationValue(
                            "exportDirectory", context.getService().getApplicationContext());
            if (external) {
        ...
        try {
            ...
            String foo =
                    ConnectionSetttingsParser.outputXML(
                            context.getConnectionSettings(), context.getPlugins());
        ...
        for (String link : context.getLinkMap().keySet()) {
            ...
            if (doExport) {
                ...
                try {
                    ...
                    context.getService()
                            .dispatchPluginSaveError(currentplugin, e.getLocalizedMessage());
                    passed = false;
                } finally {
    ...
    public void buildSettingsPage() {
        ...
        windowManager
                ...
                .getSettings()
                .setListener(
                        context.createWindowSettingsChangedListener(
                                windowManager.getWindows().get(0).getName()));
        context.getConnectionSettings()
                .getSettings()
                .getOptions()
                .addOptionAt(windowManager.getWindows().get(0).getSettings(), FOUR);
    }
