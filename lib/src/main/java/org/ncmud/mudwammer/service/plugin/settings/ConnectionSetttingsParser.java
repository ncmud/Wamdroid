...
public class ConnectionSetttingsParser extends PluginParser {
    ...
    public ConnectionSetttingsParser(
            String location,
            Context context,
    ...
    protected void attatchListeners(RootElement root) {
        ...
        dirEntries.setStartElementListener(
    ...
    public static String outputXML(ConnectionSettingsPlugin p, ArrayList<Plugin> plugins)
    ...
    private static void outputOptions(XmlSerializer out, ConnectionSettingsPlugin p)
            throws IllegalArgumentException, IllegalStateException, IOException {
    ...
    private static void dumpOptions(XmlSerializer out, SettingsGroup o)
            throws IllegalArgumentException, IllegalStateException, IOException {
