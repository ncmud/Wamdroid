...
public class WindowToken {
    ...
    private void initSettings() {
        ...
        window.setDescription(
                "Options involved with the display of text or interaction with the window.");
        ...
        hyperlinksEnabled.setDescription(
                "Make text that starts with http:// or www. a clickable link.");
    ...
    public final WindowToken copy() {
        ...
        for (LayoutGroup g : this.mLayouts.values()) {
            ...
            RelativeLayout.LayoutParams newportraitparams =
                    new RelativeLayout.LayoutParams(pparams.width, pparams.height);
            newportraitparams.setMargins(
                    pparams.leftMargin,
                    pparams.topMargin,
                    pparams.rightMargin,
                    pparams.bottomMargin);
            ...
            RelativeLayout.LayoutParams newlandscapeparams =
                    new RelativeLayout.LayoutParams(lparams.width, lparams.height);
            newportraitparams.setMargins(
                    lparams.leftMargin,
                    lparams.topMargin,
                    lparams.rightMargin,
    ...
    public final void importV1Settings(final HyperSettings s) {
        this.getSettings()
                .setOption("hyperlinks_enabled", Boolean.toString(s.isHyperLinkEnabled()));
        ...
        switch (s.getHyperLinkMode()) {
            ...
            case HIGHLIGHT:
                this.getSettings()
                        .setOption("hyperlink_mode", Integer.toString(HYPERLINK_HIGHLIGHT));
                break;
            case HIGHLIGHT_COLOR:
                this.getSettings()
                        .setOption("hyperlink_mode", Integer.toString(HYPERLINK_HIGHLIGHT_COLOR));
                break;
            case HIGHLIGHT_COLOR_ONLY_BLAND:
                this.getSettings()
                        .setOption(
                                "hyperlink_mode", Integer.toString(HYPERLINK_HIGHLIGHT_IF_BLAND));
                break;
            case BACKGROUND:
                this.getSettings()
                        .setOption("hyperlink_mode", Integer.toString(HYPERLINK_BACKGROUND));
                break;
            default:
                break;
        }
