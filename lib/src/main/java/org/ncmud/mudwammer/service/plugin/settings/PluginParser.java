...
import org.ncmud.mudwammer.alias.AliasParser;
...
import org.ncmud.mudwammer.service.WindowTokenParser;
import org.ncmud.mudwammer.service.plugin.Plugin;
import org.ncmud.mudwammer.service.plugin.settings.PluginSettings.PLUGIN_LOCATION;
import org.ncmud.mudwammer.timer.TimerData;
import org.ncmud.mudwammer.timer.TimerParser;
import org.ncmud.mudwammer.trigger.TriggerData;
import org.ncmud.mudwammer.trigger.TriggerParser;
...
public class PluginParser extends BasePluginParser {
            ...
            for (ScriptData d : p.getSettings().getScripts().values()) {
                if (d.getName().equals("bootstrap") || d.isExecute()) {
                    ...
                    if (ret != 0) {
                        ...
                        // bootstrap success.
                        // i think i can use the existing traceback, but the pcall has left a nil on
                        // the stack
                        // L.pop(1);
    ...
    protected void attatchListeners(RootElement root) {
        ...
        TriggerParser.registerListeners(
                triggers, newItemHandler, new TriggerData(), current_trigger, current_timer);

        // Element timer = timers.getChild(BasePluginParser.TAG_TIMER);
        TimerParser.registerListeners(
                timers, newItemHandler, new TimerData(), current_trigger, current_timer);

        WindowTokenParser.registerListeners(window, current_window, newItemHandler);

        scripts.setTextElementListener(
                new TextElementListener() {
                    ...
                    public void end(String body) {
                        ...
                        if (current_script_name == null) {
                            ...
                            current_script_name =
                                    Integer.toHexString(rand).toUpperCase(Locale.ROOT);
                        }
        ...
        plugin.setStartElementListener(
                new StartElementListener() {
                    ...
                    public void start(Attributes a) {
                        ...
                        Log.e(
                                "Parse",
                                "Parsing plugin: " + a.getValue("", BasePluginParser.ATTR_NAME));
        ...
        options.setStartElementListener(
                new StartElementListener() {
        ...
        fileValue.setTextElementListener(
                new TextElementListener() {
        ...
        filePath.setTextElementListener(
                new TextElementListener() {
        ...
        fileExt.setTextElementListener(
                new TextElementListener() {
        ...
        stringO.setTextElementListener(
                new TextElementListener() {
        ...
        listValue.setTextElementListener(
                new TextElementListener() {
        ...
        listItem.setTextElementListener(
                new TextElementListener() {
        ...
        callbackO.setTextElementListener(
                new TextElementListener() {
    ...
    public static void saveToXml(XmlSerializer out, Plugin plugin)
        ...
        if (plugin.getSettings().getOptions().title != null
                && !plugin.getSettings().getOptions().title.equals("")) {
            out.attribute("", "title", plugin.getSettings().getOptions().title);
        }
        if (plugin.getSettings().getOptions().description != null
                && !plugin.getSettings().getOptions().description.equals("")) {
    ...
    private static void dumpPluginOptions(XmlSerializer out, SettingsGroup o)
            throws IllegalArgumentException, IllegalStateException, IOException {
